...
Deliberately a different class from TechnicalSession (services/session_store.py)
and from the Pydantic schemas (schemas/*.py) - three different jobs:
  - TechnicalSession: in-memory shape of an in-progress attempt
...
class SavedReport(Base):
    ...
    # from the TechnicalSession at save time. Stored as plain text rather
